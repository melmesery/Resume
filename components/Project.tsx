        ...
        ({
          ...
          <div className="border border-slate-300 bg-slate-200 rounded-xl p-2 sm:p-5" key={i}>
            ...
            <div className="flex flex-row flex-wrap items-center gap-1 mt-1">
              ...
              {client && <Link href={client} target="_blank" className="border border-slate-300 hover:rounded-xl hover:bg-slate-300 px-1 sm:px-2">Client</Link>}
              {server && <Link href={server} target="_blank" className="border border-slate-300 hover:rounded-xl hover:bg-slate-300 px-1 sm:px-2">Server</Link>}
              {video && <Link href={video} target="_blank" className="border border-slate-300 hover:rounded-xl hover:bg-slate-300 px-1 sm:px-2">Video</Link>}
              {studio && <Link href={studio} target="_blank" className="border border-slate-300 hover:rounded-xl hover:bg-slate-300 px-1 sm:px-2">Studio</Link>}
            </div>
          </div>
        )
      )}
